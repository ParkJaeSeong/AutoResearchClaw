...
**Spec:** `archive/legacy/2026-09-13-design-reset/docs/superpowers/specs/2026-08-27-autoresearchclaw-codex-design.md`
...
- Create: `skills/researchclaw/agents/openai.yaml`
...
def test_plugin_manifest_and_skill_are_explicit_and_api_free():
    ...
    skill_ui = yaml.safe_load((ROOT / "skills" / "researchclaw" / "agents" / "openai.yaml").read_text())
