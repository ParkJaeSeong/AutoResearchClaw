...
**필수 읽기:** [공통 실행 계약](../common.md) · [데이터 계약과 호환성](../../../specs/research-governance/contracts.md) · [쟁점 생명주기·변경 영향·예산](../../../specs/research-governance/lifecycle.md) · [수용 시나리오](../../../specs/research-governance/acceptance.md)
