...
16. Stop. Never run the deferred command in Stage 11. Do not execute generated code, create `experiment/results.json`, install packages, download data, access a network, call an LLM, or spawn an agent. Explicit approval is a hash-bound decision only; it does not execute the experiment.
