...
| --- | --- | --- |
| `stage_completion_rate` | Higher | Completed contracts divided by all 23 declared stages. An approved stage 9 is `9 / 23`; it is not a complete research project or paper. |
...
Metrics are workflow evidence, not a claim of scientific quality. Summarize validation failures and approvals alongside the completion rate, and state that validation execution, stage 10 code generation, and paper work are deferred.
