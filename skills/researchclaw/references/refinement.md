...
- Do not disclose any assessment until all three are registered. The coordinator then registers one challenge/revision round and each voter records its final vote. Preserve every assessment, challenge, response, final vote, and minority rationale as dissent; never rewrite the dissent to make a consensus appear unanimous.
