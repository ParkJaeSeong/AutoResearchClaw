...
_LIMITATIONS = [
    '후보 수는 식별자로 통합한 보고 기록 수입니다. 고유 논문 수·검색 결과 수·독립 검증된 원문 독해 수가 아닙니다.',
    '탐색 보고와 초안 가설은 네이티브 근거 검증·코퍼스 승인·M1 완료를 의미하지 않습니다.',
    '세 역할의 보고가 모이지 않은 회차의 내용은 비공개입니다. 접근·독해 범위와 해석은 에이전트의 보고에 따른 것입니다.',
]
